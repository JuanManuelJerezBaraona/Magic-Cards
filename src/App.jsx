...
import Buscador from './components/Buscador'; // Importa el componente Buscador desde un archivo local.
import MiApi from './components/MiApi' // Importa el componente MiApi desde un archivo local.

function App() { // Define el componente funcional llamado App.
  ...
  return (
    <> {/* Abre un fragmento React para envolver varios elementos sin un div raíz. */}
      ...
      <nav className='bg-black pb-5'>
        <h1 className="text-center pt-4 mb-4 text-white">Search for your destiny.</h1>
        <Buscador
          cards={info}
